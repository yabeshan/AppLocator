                    ...
                    tap: {
                        fn: function( e, node ) {
                            if (node.id=="goDirect") {
                                ...
                                viewInfoPopup("Info", window +"__________"+ window.plugins +"==========="+ window.plugins.clipboard +"____________"+Ext.get("stationAddress").dom.innerText);
                                if (window && window.plugins) {
                                    window.plugins.copy(Ext.get("stationAddress").dom.innerText);
